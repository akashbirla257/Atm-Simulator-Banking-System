...
public class Signup2 extends JFrame implements ActionListener {
    ...
    Signup2(String formno) {
        ...
        JLabel lab1 = new JLabel("Page 2: Additonal Details");
        lab1.setFont(new Font("Raleway", Font.BOLD, 22));
        lab1.setBounds(280, 30, 600, 40);
        add(lab1);
        ...
        ButtonGroup groupSN = new ButtonGroup();
        groupSN.add(r1);
        groupSN.add(r2);
