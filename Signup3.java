...
public class Signup3 extends JFrame implements ActionListener {
    ...
    Signup3(String formno) {
        ...
        JLabel lab1 = new JLabel("Page 3: Account Details");
        lab1.setFont(new Font("Raleway", Font.BOLD, 22));
        lab1.setBounds(280, 40, 400, 40);
        add(lab1);
        ...
        c3 = new JCheckBox("Mobile Bamking");
